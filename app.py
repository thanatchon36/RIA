...
pdf_html = """<a href="https://drive.google.com/file/d/1us0Qwokb1jd04VG8pByoRdPM-76enSit/view?usp=sharing" class="card-link">PDF</a> <a href='#linkto_top' class="card-link">Link to top</a> <a href='#linkto_bottom' class="card-link">Link to bottom</a>"""
