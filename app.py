...
pdf_html = """<a href="file:///bot.or.th/cfs/FILESERV/DA_WORKSPACE/workstation/GLOBAL_WS/ria/shared/Assessingcrises.pdf" class="card-link">PDF</a> <a href='#linkto_top' class="card-link">Link to top</a> <a href='#linkto_bottom' class="card-link">Link to bottom</a>"""
